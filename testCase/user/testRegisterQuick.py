...
localRegisterQuick_xls = commons.get_xls("userCase.xlsx", "registerquick")
...
class RegisterQuick(unittest.TestCase):
    ...
    def testRegisterQuick(self):
        ...
        """
        # set url
        self.url = commons.get_url_from_xml('registerQuick')
    ...
    def checkResult(self):
        ...
        if self.result == '1':
            ...
            if self.case_name == 'registerQuick_EmailExist':
                sql = commons.get_sql('newsitetest', 'rs_member', 'delete_user')
