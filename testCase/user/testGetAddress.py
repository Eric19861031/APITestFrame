...
getAddress_xls = commons.get_xls("userCase.xlsx", "getAddress")
...
class GetAddress(unittest.TestCase):
    ...
    def testGetAddressList(self):
        ...
        """
        # set url
        self.url = commons.get_url_from_xml('getAddress')
    ...
    def checkResult(self):
        ...
        if self.result == '0':
            ...
            value = commons.get_value_from_return_json(self.info, "address", "addressId")
