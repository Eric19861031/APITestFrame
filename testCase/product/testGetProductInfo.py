...
productInfo_xls = commons.get_xls("productCase.xlsx", "getProductInfo")
...
class ProductInfo(unittest.TestCase):
    ...
    def testGetProductInfo(self):
        ...
        """
        # set uel
        self.url = commons.get_url_from_xml('productInfo')
    ...
    def checkResult(self):
        ...
        commons.show_return_msg(self.response)

        if self.result == '0':
            self.assertEqual(self.info['code'], self.code)
            self.assertEqual(self.info['msg'], self.msg)
            goods_id = commons.get_value_from_return_json(self.info, "Product", "goods_id")
